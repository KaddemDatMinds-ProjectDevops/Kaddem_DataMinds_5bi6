...
public class ContratRestController {
	...
	public Contrat addContrat(@RequestBody ContratDto c) {
		Contrat contrat = this.modelMapper.map(c, Contrat.class);
	...
	public Contrat assignContratToEtudiant (@PathVariable(name = "idContrat") Integer idContrat,@PathVariable(name = "nomE") String nomE,@PathVariable(name = "prenomE") String prenomE){
